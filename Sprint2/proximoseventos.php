<?php 
	require_once("conecta.php");
		...
		{
			$sql1= "SELECT ID_EVENTO,EVE_NOME, EVE_DATA, EVE_CIDADE FROM TBL_EVENTO WHERE SYSDATE() < EVE_DATA ORDER BY EVE_DATA;";
				...
				<div class="container">
					<table border="1">
						<tr>
							...
							<td><?=$linha['EVE_DATA']?><br></td>
							<td><?=$linha['EVE_CIDADE']?><br></td>
							<td><a href="descricaoevento.php?codigo=<?php echo $linha["ID_EVENTO"]; ?>">Ver</a></td>
						</tr>
					</table>
				</div>
			</div>
