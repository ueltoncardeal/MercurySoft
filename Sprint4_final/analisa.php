...
<!-- Primeira barra de navegação -->
	<nav id="navbar1" class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<a class="navbar-brand" href="#">
		  ...
		  <form class="form-inline my-2 my-lg-0" method="POST" action="pesquisarmoderador.php">
...
?>
			...
			<tbody>
						...
						<td><a  class="btn btn-primary" href="analisadescricaoevento.php?codigo=<?php echo $linha["ID_EVENTO"]; ?>">Ver</a></td>
						<td><a class="btn btn-success" href="aprova.php?codigo=<?php echo $linha['ID_EVENTO'];?>">Aprovar</a> <a class="btn btn-danger" href="rejeita.php?codigo=<?php echo $linha['ID_EVENTO'];?>">Rejeitar</a></td>
