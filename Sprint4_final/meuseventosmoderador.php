...
?>
			...
			<tbody>
			    <tr>
						...
						<td><a href="descricaoeventologadomoderador.php?codigo=<?php echo $linha["ID_EVENTO"]; ?>">Ver</a>
							<?php if ($linha['EVE_STATUS'] == 'PENDENTE'){ ?>
							<a href="editareventomoderador.php?codigo=<?php echo $linha['ID_EVENTO'];?>">Editar</a></td>
						<?php }  ?>																									    
				</tr>
			</tbody>
