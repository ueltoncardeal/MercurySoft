<?php 
	require_once("conecta.php");
			$sql1= "SELECT ID_EVENTO,EVE_NOME, EVE_DATA, EVE_CIDADE, EVE_RESULTADO FROM TBL_EVENTO WHERE SYSDATE() > EVE_DATA  AND EVE_STATUS = 'APROVADO' ORDER BY EVE_DATA;";
			...
			$linkresult = $linha['EVE_RESULTADO'];					
 ?>
				...
				<div class="container">
					<table border="1">
						<tr>
							...
							<tr><a href="<?php echo $linkresult; ?>">Ver resultado</a></tr>
						</tr>
					</table>
				</div>
			</div>
