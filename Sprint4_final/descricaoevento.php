...
<div class="jumbotron" id="jumbotronPrincipal" style="background-color: #d7dbd2"> 
	...
	$_SESSION["EVENTO"] = $row[0];	
	$_SESSION["ID_EVENTO"] = $row[14];
	...
	<a class="btn btn-primary" href="javascript:void(0)" onclick="window.open('cadastroemail.html', 'Pagina', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESIZABLE=NO, SCROLLBARS=NO, MENUBAR=NO, TOP=90%, LEFT=280%, WIDTH=485, HEIGHT=545');">Seguir</a>
</div>
