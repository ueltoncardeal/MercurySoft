<?php 
	require_once("conecta.php");
		...
		$sql1= "SELECT EVE_NOME, EVE_DATA, EVE_CIDADE, ID_EVENTO FROM TBL_EVENTO WHERE SYSDATE() < EVE_DATA AND EVE_STATUS = 'APROVADO' ORDER BY EVE_DATA LIMIT 3;";
	...
	<nav id="navbar1" class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<a class="navbar-brand" href="#">
		  ...
		  <form class="form-inline my-2 my-lg-0" method="POST" action="pesquisar.php">
		      ...
		      <button class="btn btn-outline-success my-2 my-sm-0" type="submit" value="enviar" id="btnPesquisar" name="btnPesquisar">Pesquisar</button>
		  </form>
		  
	  	</div>
	  	<a id="entrar" class="btn " href="login.html">Entrar</a>
	  	 <a id="cadastrar" class="btn " href="cadastrauser.html">Cadastrar</a>
	</nav>
					  ...
					  <div class="carousel-inner">
					    ...
					    <div class="carousel-item active">
					      <img src="images/img1.png" class="d-block w-100" alt="...">
					       <div class="carousel-caption d-none d-md-block">
					       	...
					       	?>
					       	<a href="descricaoevento.php?codigo=<?php echo $row[3]; ?>">
						    <h5 id="h5carousel"><?php printf ("%s", $row[0]);?></h5>

						    <p id="pcarousel"><?php printf ("%s \n", $row[2]); 
						    						printf (date("d/m/Y", strtotime($row[1])))?> </p></a>
					    ...
					    <div class="carousel-item">
					      ...
					      <div class="carousel-caption d-none d-md-block">
						    ...
						    <h5 id="h5carousel"><?php printf ("%s", $row[0]);?></h5>
						    <p id="pcarousel"><?php printf ("%s \n", $row[2]); 
						    						printf (date("d/m/Y", strtotime($row[1])))?>
						    						</p></a>
						  </div>
					    </div>
					    <div class="carousel-item">
